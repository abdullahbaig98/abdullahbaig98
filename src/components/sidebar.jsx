...
<Row className='Side' style={{float:'right',height:'100%'}}>
      ...
      <  div className="btn  card bg-dark  rounded-0  " style={{width: '12rem', opacity:'0.6', height: '120px', border:'1px solid black'}}>
   
  <div className="card-body" >
  <h5 className="card-title text-light" style={{visibility:'hidden'}}>.</h5>
...
<  div  className="btn btn-hover card bg-dark rounded-0  " style={{width: '12rem', opacity:'0.6', height: '120px', border:'1px solid black'}}>

<div className="card-body">
<h5 className="card-title text-light" style={{visibility:'hidden'}}>1</h5>
...
< div className="btn   card bg-dark  rounded-0" style={{width: '12rem', opacity:'0.6', height: '126px', border:'1px solid black'}}>
