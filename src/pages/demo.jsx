    ...
    <Row md={12} lg={2} className='roww'>
        <Col>
          <Card bg='transparent' border='0' className='w-100 h-100 cr'>
            <Card.Body>
              <Card.Subtitle className="mb-2 text-dark" style={{ fontFamily: "Helvetica Neue" }}>Strategy, UI/UX.{'\u00A0\u00A0\u00A0'} {'\u00A0\u00A0\u00A0'} June 6, 2023</Card.Subtitle>
              <Card.Title><h1 style={{ fontFamily: "Calibri", fontWeight: 'bolder', fontSize: '65px', lineHeight: '1.2' }}>Watch Demo</h1>
        ...
        <Col>
          <Card bg='transparent' border='0' className='w-100 h-100' style={{paddingTop:'10%'}}>
           <Card.Title className='icon1'>
           <FontAwesomeIcon icon={faGreaterThan} style={{paddingLeft:'4%', color:'white', fontSize:'60px'}} className='btn' onClick={handleOpenModal} >
           <Vediomodal isOpen={isModalOpen} onClose={handleCloseModal} />
           </FontAwesomeIcon>
           </Card.Title>
          </Card>
        </Col> 
