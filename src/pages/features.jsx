...
const  features =  ()  =>{
    return<>
    <div className='roww1'>
 <section className="feature-section img-fluid" style={{  width:'70%',height:'30%'}}>
   
            <div className="row">
                <div className="col-md-12 text-center heading-main heading-main-white">
                    <h2 className="heading">OUR FEATURES</h2>
                    <div className="separator"><i class="fa fa-home below-line-about-icon"></i></div>
            ...
            <div className="row">
                <div className="col-md-4 feature-back ">
                    <div className="features-div">
                        ...
                        <h2 className="features-heading"><br></br>Interior Expertise</h2>
                        <p>
                ...
                <div className="col-md-4 feature-back">
                    ...
                    <FontAwesomeIcon icon={faBullseye} className='icn'/>
                        ...
                        <h2 className="features-heading"><br></br>Awards Winning</h2>
                        <p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since
                        </p>
                    </div>
                ...
                <div className="col-md-4 feature-back">
                    ...
                    <FontAwesomeIcon icon={faBookOpen} className='icn'/>
                        <h2 className="features-heading"><br></br>Reasonable Price</h2>
                        <p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since
                        </p>
                    </div>
